        ...
        {sectorData.map((d) => {
          ...
          return (
            <div key={d.sector} className="flex items-center gap-3">
              ...
              <div className="text-[10px] text-gray-500 w-14 text-right shrink-0 font-mono">
                均{d.avgScore}分
              </div>
            </div>
          );
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div>
          <p className="text-[11px] text-gray-500 mb-2">五維平均分佈雷達圖</p>
            ...
            <div key={d.dim}>
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] text-gray-500">均{d.avgScore}/{d.maxScore}分</span>
                </div>
                <div className="flex items-center gap-2 text-[10px]">
                  <span className="text-emerald-600 font-mono font-bold">{d.accuracy}%</span>
                  <span className="text-gray-500">隔日正報酬</span>
                </div>
              </div>
  ...
  return (
    <div className="min-h-dvh bg-white text-gray-900 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-screen-xl mx-auto w-full px-4 py-5">
        ...
        {/* Hero */}
        <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-sky-50 via-white to-blue-50 px-5 py-5 relative overflow-hidden mb-5">
          ...
          <div className="flex items-start justify-between flex-wrap gap-4">
            <div>
              <h1 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                ...
                推薦追蹤儀表板
                <span className="text-[10px] text-sky-600 bg-sky-100 border border-sky-200 px-2 py-0.5 rounded-full font-normal">即時統計</span>
              </h1>
              <p className="text-xs text-gray-500 mt-1">回測績效追蹤、族群勝率分析、各維度準確度統計</p>
            ...
            {latestData && (
              <div className="text-right">
                ...
                <div className="text-base font-mono font-bold text-sky-600">{latestData.scan_date}</div>
                <div className="text-[11px] text-gray-500 mt-0.5">
                  共 <span className="text-gray-700 font-mono">{latestData.scanned_count?.toLocaleString()}</span> 檔
                </div>
              </div>
            )}
          </div>
