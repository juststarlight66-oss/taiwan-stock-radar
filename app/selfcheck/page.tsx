          ...
          <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-gray-900 via-gray-900 to-sky-950/30 px-5 py-5 relative overflow-hidden">
            ...
            <div>
              <h1 className="text-lg font-bold text-white flex items-center gap-2">
                ...
                自主檢查
                <span className="text-[10px] text-sky-400 bg-sky-500/10 border border-sky-500/20 px-2 py-0.5 rounded-full font-normal">即時評分</span>
              </h1>
              <p className="text-xs text-gray-400 mt-1">輸入股票代號，即時查詢五維度評分與策略建議</p>
              <div className="flex flex-wrap gap-2 mt-3">
                {['技術面', '基本面', '消息面', '情緒面', '籌碼面'].map((t) => (
